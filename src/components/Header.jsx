  ...
  const handleCheckoutSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        message:
          checkoutForm.message || "Quotation request for selected items.",
      ...
      <header id="ori-header" className="ori-header-section header-style-one">
        <div className="ori-header-content-area">
            ...
            <div className="brand-logo">
              <Link to="/">
                <img
                  ...
                  alt="Samruddhi Enterprises Logo"
                />
              </Link>
            </div>
                ...
                <nav className="ori-main-navigation clearfix ul-li">
                  <ul id="main-nav" className="nav navbar-nav clearfix">
                    {navLinks.map((link) => {
                      ...
                      const isActive =
                        !isHash && location.pathname === link.path;
                      return (
                        <li
                          key={link.path}
          ...
          <div className="mobile_menu position-relative">
            ...
            <div
              className={`mobile_menu_wrap ${isMobileMenuOpen ? "mobile_menu_open" : ""}`}
              style={{
      ...
      {isCartOpen && (
        ...
        >
          ...
          >
            ...
            >
              <h4 style={{ color: "#00ffcc", fontWeight: "bold", margin: 0 }}>
                Requirement Cart
              </h4>
              <button
            ...
            {cartItems.length === 0 ? (
              <div className="text-center py-5" style={{ flex: 1 }}>
                ...
                <p style={{ fontSize: "13px", color: "#777" }}>
                  Browse products and add them to request a quote.
                </p>
                <button
              ...
              >
                  ...
                  {cartItems.map((item) => (
                    ...
                    >
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        <div style={{ fontSize: "12px", color: "#00ffcc" }}>
                          {item.price}
                        </div>
                ...
                {/* Checkout/Quote Form */}
                <div
                  style={{ borderTop: "1px solid #222", paddingTop: "20px" }}
                >
                  <h5
                    style={{
                      color: "#00ffcc",
